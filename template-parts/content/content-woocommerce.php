...
// Default Grid
function minimalist_add_woocommerce_support() {
  ...
  add_action( 'after_setup_theme', 'minimalist_add_woocommerce_support' );
  
  // Wrapper Woocommerce
  add_action ('woocommerce_before_main_content', 'minimalist_wrapper_start', 10);
  add_action ('woocommerce_after_main_content', 'minimalist_wrapper_end', 10);
  
  function minimalist_wrapper_start () {
    echo '<section id = "main-woocommerce">';
  }
  
  function minimalist_wrapper_end () {
    echo '</section>';
  }
